...
export const getColumns = ({
  ...
  },
  {
    title: (
      <HeaderCell
        title={<span className="whitespace-nowrap">Purchased</span>}
      />
    ),
    dataIndex: 'purchased',
    key: 'purchased',
    ...
    render: (purchased: string) => (
      <span className="mr-6 block whitespace-nowrap">{purchased}</span>
    ),
  },
  {
    title: (
      <HeaderCell
        title={<span className="whitespace-nowrap">Completed</span>}
      />
    ),
    dataIndex: 'completed',
    key: 'completed',
    ...
    render: (completed: string) => (
      <span className="mr-6 block whitespace-nowrap">{completed}</span>
    ),
  },
  // {
  //   title: (
