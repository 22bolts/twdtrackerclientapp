...
import SessionOverviewCards from './sessionsOverview';
import SessionList from '../../ecommerce/dashboard/sessions-list';
  ...
  return (
    <div className="@container">
      <div className="grid grid-cols-12 gap-6 3xl:gap-8">
        ...
        <SessionOverviewCards className="col-span-full" />

        {/* <DeliveryStatus className="col-span-full" /> */}
        
        <SessionsChart className="col-span-full" />
