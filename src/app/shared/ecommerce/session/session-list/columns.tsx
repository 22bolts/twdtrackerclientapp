...
export const getColumns = ({
  ...
  {
    title: <HeaderCell title="Session ID" />,
    dataIndex: 'id',
    key: 'id',
    width: 90,
  ...
  },
  {
    ...
    render: (_: string, row: any) => (
      <div className="flex gym-center justify-end gap-3 pe-4">
        <Tooltip
          size="sm"
          content={'Edit Order'}
          placement="top"
...
export const getWidgetColumns = ({
  ...
  {
    title: (
      <HeaderCell title="Session ID" className="ps-4 [&>div]:whitespace-nowrap" />
    ),
    dataIndex: 'id',
    key: 'id',
    width: 90,
